...
10) `db/migrations/2026_lead_tasks_followups.sql` (tarefas/follow-ups de leads)
11) (Opcional) `db/migrations/2026_vehicle_photos_storage.sql` (bucket + policies do Storage)
12) `db/rls.sql`
